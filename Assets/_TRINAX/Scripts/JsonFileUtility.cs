...
public class JsonFileUtility
{
    ...
    public static string LoadJsonFromFile(string path, JSONSTATE state)
    {
        ...
        switch (state)
        {
            ...
            case JSONSTATE.GAME_DATA_PATH:
                ...
                break;
            case JSONSTATE.STREAMING_ASSETS:
                loadJsonString = LoadJsonFromStreamingAssets(path);
                break;
        }
    ...
    public static void WriteJsonToFile(string path, string content, JSONSTATE state)
    {
        switch (state)
        {
            ...
            case JSONSTATE.GAME_DATA_PATH:
                ...
                break;
            case JSONSTATE.STREAMING_ASSETS:
                WriteJsonToStreamingAssets(path, content);
                break;
        }
    }
    ...
    // Load from game data path
    static string LoadJsonFromStreamingAssets(string path) {
    ...
    static void WriteJsonToStreamingAssets(string path, string content) {
        path = Application.streamingAssetsPath + "/" + path;
