...
//                calibrationText.text = "CALIBRATION WAS INTERUPTED...";
//                yield break;
//            }
...
//                calibrationText.text = calibrationImage.fillAmount < 0.3f ? "CALIBRATION IN PROGRESS..." :
//                                        calibrationImage.fillAmount < 0.5f ? "HALFWAY THERE" :
//                                        calibrationImage.fillAmount < 0.95f ? "JUST A LITTLE MORE..." : "DONE!";
//            yield return new WaitForSeconds(0.02f);
//        }

//        if (calibrationImageParent != null)
//            calibrationImageParent.transform.DOLocalJump(calibrationImage.transform.localPosition, 100f, 1, 0.4f);
//        //if (calibrationText != null)
